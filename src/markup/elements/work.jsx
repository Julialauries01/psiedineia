            ...
            <div className="row justify-content-center">
                ...
                <div className="work-bx">
                  ...
                  <div className="work-content">
                    ...
                    <p>
                      Ajudo adolescentes a explorar seus desafios e descobrir
                      novas habilidades para uma vida equilibrada e satisfatória
                    </p>
                  </div>
              ...
              <div className="col-lg-4 col-sm-6 mb-30">
                <div className="work-bx active">
                  ...
                  <div className="work-content">
                    ...
                    <p>
                      Juntos, poderemos trabalhar as diversas demandas e
                      obstáculos da vida adulta.
                    </p>
                  </div>
                  <Link to="/contact-us" className="btn btn-primary light">
                    Ver mais{" "}
              ...
              <div className="col-lg-4 col-sm-6 mb-30">
                <div className="work-bx">
                  ...
                  <div className="work-content">
                    <h5 className="title text-secondary mb-10">Casais</h5>
                    <p>
                      Acompanhamento psicológico para casais que buscam melhorar
                      o diálogo, fortalecer a relação e enfrentar desafios
                      emocionais juntos.
                    </p>
                  </div>
                  <Link to="/contact-us" className="btn btn-primary light">
