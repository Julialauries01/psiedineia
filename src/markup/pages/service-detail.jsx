                ...
                <div className="col-lg-8 mb-30">
                  ...
                  <div className="clearfix">
                    <div className="head-text mb-30">
                      <h2 className="title mb-15">
                        Como a Psicologia Pode Transformar Sua Vida
                      </h2>
                      <p className="mb-0">
                        O acompanhamento psicológico oferece um espaço seguro e
                        acolhedor para compreender emoções, desenvolver
                        autoconhecimento e construir estratégias mais saudáveis
                        para lidar com ansiedade, depressão, conflitos, traumas,
                    ...
                    <div className="row align-items-center">
                      ...
                      <div className="col-md-6 mb-30">
                        ...
                        <div className="skillbar-box mb-30">
                          <h6 className="title">
                            Sigilo Garantido (Código de Ética)
                          </h6>
                          <div className="skillbar appear">
                            <p
                              className="skillbar-bar"
                  ...
                  <div className="clearfix">
                    <div className="head-text mb-30">
                      ...
                      <p className="mb-0">
                        Tire algumas das principais dúvidas sobre o processo
                        terapêutico.
                      </p>
                    </div>
                    ...
                    >
                      <Accordion.Item eventKey="0">
                        ...
                        <Accordion.Body>
                          <p className="mb-0">
                            A terapia ajuda você a compreender emoções,
                            identificar padrões, reduzir ansiedade, melhorar
                            relacionamentos e desenvolver habilidades emocionais
                            para viver de forma mais equilibrada.
                          </p>
                        </Accordion.Body>
                      </Accordion.Item>
                      ...
                      <Accordion.Item eventKey="1">
                        ...
                        <Accordion.Body>
                          <p className="mb-0">
                            A duração varia de pessoa para pessoa. Alguns buscam
                            apoio para questões específicas, outros para
                      ...
                      <Accordion.Item eventKey="2">
                        ...
                        <Accordion.Body>
                          <p className="mb-0">
                            Sim. Todo atendimento psicológico segue regras de
                            sigilo definidas pelo Código de Ética Profissional.
                          </p>
                        </Accordion.Body>
                      </Accordion.Item>
                      ...
                      <Accordion.Item eventKey="3">
                        ...
                        <Accordion.Body>
                          <p className="mb-0">
                            Psicólogos trabalham com terapia e apoio emocional.
                            Psiquiatras são médicos que podem prescrever
                            medicação. Em muitos casos, ambos trabalham em
                            conjunto.
                          </p>
                        </Accordion.Body>
                      </Accordion.Item>
                      ...
                      <Accordion.Item eventKey="4">
                        ...
                        <Accordion.Body>
                          <p className="mb-0">
                            Sim. A terapia online é regulamentada e oferece o
                            mesmo sigilo, acolhimento e qualidade do atendimento
                            presencial.
                          </p>
                        </Accordion.Body>
                      </Accordion.Item>
