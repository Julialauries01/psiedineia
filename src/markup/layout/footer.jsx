						...
						<div className="footer-bottom">
							<div className="row">
								<div className="col-12 text-center">
									<p className="copyright-text">  Copyright © 2024 Desenvolvido e Projetado por  <a href="http://linkedin.com/in/julialauries/" rel="noreferrer" target="_blank" className="text-secondary">Julia Laurie</a></p>
								</div>
							</div>
						</div>
					</div>
